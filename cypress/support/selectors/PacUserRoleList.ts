...
export const PacUserRoleListPageSelectors = {
    ...
    tableRowCountDisplay: "[data-testid='reportGridPacUserRoleList-paginator-pagination-count-display']",

    filterHeader: "[data-testid='reportConnectedPacUserRoleList-filter-header']",
