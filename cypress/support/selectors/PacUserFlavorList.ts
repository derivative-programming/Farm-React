...
export const PacUserFlavorListPageSelectors = {
    ...
    tableRowCountDisplay: "[data-testid='reportGridPacUserFlavorList-paginator-pagination-count-display']",

    filterHeader: "[data-testid='reportConnectedPacUserFlavorList-filter-header']",
