...
export const TacFarmDashboardPageSelectors = {
    ...
    tableRowCountDisplay: "[data-testid='reportGridTacFarmDashboard-paginator-pagination-count-display']",

    filterHeader: "[data-testid='reportConnectedTacFarmDashboard-filter-header']",
