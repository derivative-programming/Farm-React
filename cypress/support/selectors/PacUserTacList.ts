...
export const PacUserTacListPageSelectors = {
    ...
    tableRowCountDisplay: "[data-testid='reportGridPacUserTacList-paginator-pagination-count-display']",

    filterHeader: "[data-testid='reportConnectedPacUserTacList-filter-header']",
