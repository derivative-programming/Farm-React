...
export const PacUserTriStateFilterListPageSelectors = {
    ...
    pagingControl: "[data-testid='reportGridPacUserTriStateFilterList-paginator-pagination']",
    pageSizeControl: "[data-testid='reportGridPacUserTriStateFilterList-paginator-pagination-select-page-size']",
    pageSizeControlLabel: "[data-testid='items-per-page-label']",
    tableRowCountDisplay: "[data-testid='reportGridPacUserTriStateFilterList-paginator-pagination-count-display']",

    filterHeader: "[data-testid='reportConnectedPacUserTriStateFilterList-filter-header']",
