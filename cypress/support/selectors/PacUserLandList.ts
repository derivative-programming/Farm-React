...
export const PacUserLandListPageSelectors = {
    ...
    pagingControl: "[data-testid='reportGridPacUserLandList-paginator-pagination']",
    pageSizeControl: "[data-testid='reportGridPacUserLandList-paginator-pagination-select-page-size']",
    pageSizeControlLabel: "[data-testid='items-per-page-label']",
    tableRowCountDisplay: "[data-testid='reportGridPacUserLandList-paginator-pagination-count-display']",

    filterHeader: "[data-testid='reportConnectedPacUserLandList-filter-header']",
