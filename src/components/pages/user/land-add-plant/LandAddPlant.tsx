...
const LandAddPlant: FC = (): ReactElement => {
...
var x = 1;
    ...
    landAddPlantService(data, params["id"])
        .then((res: any) => {
  ...
  return (
    ...
    <div className="land-add-plant-container" data-testid="land-add-plant-container">
      <Card>
