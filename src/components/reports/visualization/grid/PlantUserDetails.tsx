...
export const ReportGridPlantUserDetails: FC<ReportGridPlantUserDetailsProps> = ({
    ...
    const handleRowSelectCheckboxChange = (
        ...
        if (e.target.checked) {
            ...
            setCheckedIndexes(checkedIndexes.filter(item => item));
        } else {
            ...
            >
                <thead>
                    <tr>
                        ...
                        <th id="UpdateButtonTextLinkPlantCodeCColumnHeader"></th>
                        <th id="RandomPropertyUpdatesLinkPlantCodeColumnHeader"></th>
                    </tr>
                </thead>
                <tbody>
                    {items && items.length
