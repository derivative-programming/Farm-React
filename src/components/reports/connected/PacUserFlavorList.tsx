...
import { ReportDetailThreeColPacUserFlavorList } from "../visualization/detail-three-column/PacUserFlavorList";
import { ReportDetailTwoColPacUserFlavorList } from "../visualization/detail-two-column/PacUserFlavorList";
