...
import * as loginController from "../../services/auth";
...
describe("Login Component", () => {
  ...
  const mockLogin = jest.spyOn(loginController, "login");
  ...
  it("when user entered login details and clicks on login button, login api should be called", async () => {
